...
public function send_smtp_mail($msg = NULL, $sub = NULL, $to = NULL, $from = NULL)
{
    ...
    // Set BCC recipients in the email configuration
    $config['bcc_batch_mode'] = true;
    $config['bcc_batch_size'] = 200; // Set an appropriate batch size
    ...
    // You can remove this line as BCC is set in the email configuration
    $this->email->bcc($to);
